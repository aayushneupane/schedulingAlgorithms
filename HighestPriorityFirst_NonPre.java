 ...
 *
 */
public class HighestPriorityFirst_NonPre
{
     ...
     * @param currTime
     */
    private static void processSwitch(PriorityQueue readyQueues, float currTime)
    {
        
        if(!readyQueues.isEmpty()  && readyQueues.getCurrentProc().getRunTime() <= 0)
        {
            readyQueues.removeCurrentProc(currTime);
        }
    }
}
